                ...
                <tbody>
                    @foreach($orders as $order)
                        <tr>
                            ...
                            <td>{{ $order->status }}</td>
                            <td>
                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#statusModal{{ $order->id }}">
                                    <i class="fas fa-pencil-alt"></i> Edit Status
                                </button>
                            </td>
                            <td>
                                @if($order->invoice)
                                    <a href="{{ route('invoice.index', $order->invoice->id) }}" class="btn btn-info">
                                        <i class="fas fa-search"></i> Lihat Invoice
                                    </a>
                                @else
                                    <span class="text-muted">Belum Tersedia</span>
                                @endif
